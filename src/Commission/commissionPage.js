...
class CommissionPage extends React.Component {
  ...
  static getDerivedStateFromProps(nextProps, state) {
    // if (
    //   nextProps.route.params.paymentStatus !== state.paramPaymentStatusIndex
    // ) {
    //   return {paramPaymentStatusIndex: nextProps.route.params.paymentStatus};
    // }
    return {};
  }
  ...
  componentDidUpdate() {
    if (
      ...
      this.state.paramPaymentStatusIndex
    ) {
  ...
  loadCommissionList = () => {
    this.setState(
      {
        isLoading: true,
        selectedFilterIndex: this.props.route.params.paymentStatus,
        paramPaymentStatusIndex: this.props.route.params.paymentStatus,
      },
